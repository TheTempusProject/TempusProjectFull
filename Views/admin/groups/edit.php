<form action="" method="post" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-3">
            <input name="sendMessages" id="sendMessages" type="checkbox" value="true"{CHECKED:sendMessages=true}>
        </div>
    </div>
    <div class="form-group">
        <label for="uploadImages" class="col-lg-3 control-label">Upload Images</label>
        <div class="col-lg-3">
            <input name="uploadImages" id="uploadImages" type="checkbox" value="true"{CHECKED:uploadImages=true}>
        </div>
    </div>
    <div class="form-group">
        <label for="feedback" class="col-lg-3 control-label">Send Feedback</label>
        <div class="col-lg-3">
            <input name="feedback" id="feedback" type="checkbox" value="true"{CHECKED:feedback=true}>
        </div>
    </div>
    <div class="form-group">
        <label for="bugreport" class="col-lg-3 control-label">Submit Bug Reports</label>
        <div class="col-lg-3">
            <input name="bugreport" id="bugreport" type="checkbox" value="true"{CHECKED:bugreport=true}>
        </div>
    </div>
    <div class="form-group">
        <label for="member" class="col-lg-3 control-label">Member Access</label>
        <div class="col-lg-3">
            <input name="member" id="member" type="checkbox" value="true"{CHECKED:member=true}>
        </div>
    </div>
    <div class="form-group">
        <label for="modCP" class="col-lg-3 control-label">Moderator Privileges</label>
        <div class="col-lg-3">
            <input name="modCP" id="modCP" type="checkbox" value="true"{CHECKED:modCP=true}>
        </div>
    </div>
    <div class="form-group">
        <label for="adminCP" class="col-lg-3 control-label">Administrator Privileges</label>
        <div class="col-lg-3">
            <input name="adminCP" id="adminCP" type="checkbox" value="true"{CHECKED:adminCP=true}>
        </div>
    </div>
